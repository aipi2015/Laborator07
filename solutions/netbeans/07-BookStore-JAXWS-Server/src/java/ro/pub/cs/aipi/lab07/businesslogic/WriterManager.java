...
@WebService(serviceName = "WriterManager")
public class WriterManager extends PersistentEntityManager<Writer> implements WriterManagerInterface {
    ...
    @WebMethod(operationName = "deleteWritersWithoutBooks")
    @Override
    ...
    @WebMethod(operationName = "getWritersBibliography")
    @Override
    public List<WriterInformation> getWritersBibliography(@WebParam(name = "numberOfBooksTotal") int numberOfBooksTotal, @WebParam(name = "numberOfBooksAlone") int numberOfBooksAlone,
            @WebParam(name = "numberOfBooksCollaboration") int numberOfBooksCollaboration) {
