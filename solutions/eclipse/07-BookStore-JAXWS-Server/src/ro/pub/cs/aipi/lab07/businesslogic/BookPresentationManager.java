...
@WebService(serviceName = "BookPresentationManager")
public class BookPresentationManager extends PersistentEntityManager<BookPresentation>
	...
	public List<BookPresentationInformation> updateBookPresentationPriceForBooksWithMultipleFormats(@WebParam(name = "numberOfFormats") int numberOfFormats,
